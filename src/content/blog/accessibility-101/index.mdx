...
<figure>
	<div class="grid md:grid-cols-2 not-prose">
		<div class="bg-purple-50 text-purple-300 p-12 rounded-t-2xl md:rounded-s-2xl md:rounded-te-none">
		...
		<div class="bg-purple-900 p-12 rounded-b-2xl md:rounded-e-2xl md:rounded-be-none">
			<h4 class="font-bold text-purple-50 text-lg mb-4">Use appropriate colour contrast</h4>
			<p class="text-sm text-purple-200">On the other hand, this text has enough contrast for everyone to enjoy.</p>
		</div>
	</div>
...
<figure>
	<div class="flex items-center gap-4 p-4 rounded-2xl border border-grey-200 not-prose">
		<div class="size-3.5 bg-green-400 border border-green-600 rounded-full"></div>
		<div class="flex flex-col md:gap-2 md:flex-row md:items-center">
			<h4 class="font-bold text-grey-950">Sophie Wardhaugh</h4>
			<p class="text-sm text-grey-500">Customer service</p>
		</div>
	</div>
...
<figure>
	<div class="flex items-center gap-4 p-4 rounded-2xl border border-grey-200 not-prose">
		...
		<span class="text-green-700 ms-auto text-xs uppercase tracking-wide">Online</span>
	</div>
...
<figure>
	<div class="not-prose flex flex-col gap-6 px-8 py-6 rounded-lg border border-grey-200">
		<div>
...
<figure>
	<div class="not-prose flex flex-wrap gap-4">
		<div class="bg-grey-950 text-grey-50 w-full max-w-62.5 h-62.5 p-6">
		...
		<div class="w-full max-w-62.5 h-62.5 bg-grey-100 flex flex-col justify-center @container">
			<div class="bg-white border border-grey-200 @md:flex @md:items-center @md:gap-4 p-4 @md:rounded-2xl">
