...
pubDate: "May 9 2026"
heroImage: "@/assets/accessibility-101.png"
---
...
<figure>
	<div class="not-prose flex flex-col gap-6 px-8 py-6 rounded-lg border border-colour-light dark:border-none dark:bg-white/5">
		...
		<div>
			...
			<p class="text-sm">Text with a reasonable line height is just right. Text has room to breathe and feels more natural. Again, you can probably read all of these in this short example, but in other contexts, and for other people, that may be a different story.</p>
		</div>
		<div>
